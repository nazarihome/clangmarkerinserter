...
//  struct path_finder : public ModulePass {
//    static char ID; // Pass identification, replacement for typeid
//    path_finder() : ModulePass(ID) {}
//    map<Function*,set<vector<BasicBlock*>>*> pathMap;
//    bool runOnModule(Module &M) override{
//        for(Module::iterator F=M.begin();F!=M.end();F++){
//            findpaths(*F);
//        }
//        for(map<Function*,set<vector<BasicBlock*>>*>::iterator funcIt=pathMap.begin();funcIt!=pathMap.end();funcIt++)
//            for(set<vector<BasicBlock*>>::iterator pathsetIt=funcIt->second->begin();pathsetIt!=funcIt->second->end();pathsetIt++ ){
//                vector<BasicBlock*> vec=*pathsetIt;
//                for(vector<BasicBlock*>::iterator BBvecIt=vec.begin();BBvecIt!=vec.end();BBvecIt++ ){
//                    BasicBlock* BB=*BBvecIt;
//                }
//                
//            
//            }
//    }
//    bool findpaths(Function &F)  {
...
//            errs()<<"\n";
//
//            (pathMap[&F])->insert(tempCompletePath);
//            list<Loop*> pathLoops;
//            int bbcounter=0;
//            for(int j=0;j<tempCompletePath.size();j++){
...
//    }
//    bool callsInBB(BasicBlock* BB,vector<BasicBlock*> curpath){
...
//                    set<vector<BasicBlock*>> callpaths=pathMap[func];
//                   vector<BasicBlock*> path_init,path_out;
//                   completePathWithCalls(path_init,path_out;);
//                }
//                
//            }
//            
//        }
//    }
////    void completePathWithCalls(vector<BasicBlock*>& path_init,vector<BasicBlock*>& path_out){
////        
////        
////    }
