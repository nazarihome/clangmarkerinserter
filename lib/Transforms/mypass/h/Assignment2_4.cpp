...
namespace {
  ...
  struct Assignment_2_4: public FunctionPass {
    static char ID;
    int change;
    Assignment_2_4() : FunctionPass(ID) {change=0;}
...
char Assignment_2_4::ID = 0;
static RegisterPass<Assignment_2_4> X("Assignment_2_4", "Unsoundness Check");
